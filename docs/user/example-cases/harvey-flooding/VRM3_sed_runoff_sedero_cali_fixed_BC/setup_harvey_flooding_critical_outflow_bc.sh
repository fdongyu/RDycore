...
no_ceed=0
sed_dir_c0="/global/cfs/projectdirs/m4267/dongyu/DATA/ELM/sedero0_S1_runoff_limited_cali_sedero"
sed_dir_c1="/global/cfs/projectdirs/m4267/dongyu/DATA/ELM/sedero1_S1_runoff_limited_cali_sedero"
sed_dir_c2="/global/cfs/projectdirs/m4267/dongyu/DATA/ELM/sedero2_S1_runoff_limited_cali_sedero"
sediment_args=""
...
display_help() {
  ...
  echo "   --problem_name <Turning_30m|Houston1km|VRM3>  Supported problems"
...
if [ "$mach" == "pm-cpu" ]; then
  ...
  rain_dir="/global/cfs/projectdirs/m4267/dongyu/DATA/ELM/runoff_S1"
...
elif [ "$problem_name" == "VRM3" ]; then
  yaml_file=HoustonVRM3_sed.CriticalBC.yaml
  exo_file=Turning_30_90_1500_1000.exo
  ic_file=Turning_30_90_1500_1000_IC0.bin
  ic_file_sed=Turning_30_90_1500_1000_IC_sed_h0m_c0.bin
  sediment_args="-raster_sediment_start_date 2017,8,23,23,0 -raster_sediment_dirs ${sed_dir_c0},${sed_dir_c1},${sed_dir_c2}"
else
...
then
  ...
  if [ "$problem_name" == "Turning_30m" ]; then
    ...
    data_dir=/global/cfs/projectdirs/m4267/dongyu/DATA/VRM3_sed
  else
  ...
  sed -i "s|PLACEHOLDER_SEDIMENT_ARGS|${sediment_args}|g" ${batch_filename}
